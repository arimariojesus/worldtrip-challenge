...
export const SliderItem = () => {
  return (
    <AspectRatio
      ...
      bgPos="center"
    >
      <Stack spacing={[2, 4]} bg="rgba(0,0,0,0.3)">
        <Heading color="gray.50" fontSize={['2xl', '3xl', '5xl']}>Europa</Heading>
        <Text color="gray.200" fontSize={['lg', 'xl', '2xl']}>O continte mais antigo.</Text>
      </Stack>
    </AspectRatio>
  );
};